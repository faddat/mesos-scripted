...
apt-get update
apt-get install oracle-java9-installer apt-transport-https git build-essential autoconf dh-autoreconf software-properties-common python-software-properties libcurl curl autotools-dev automake libsvn-dev libapr1 libapr1-dev libtool build-essential python-dev python-boto libcurl4-nss-dev libsasl2-dev maven libapr1-dev libsvn-dev sbt aptitude clang
